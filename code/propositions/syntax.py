...
class Formula:
    ...
    def __find_variables(self, var_set):
        ...
        if is_constant(self.root):
            ...
            var_set = self.first.__find_variables(var_set)
        else:
            var_set = self.first.__find_variables(var_set)
            var_set = self.second.__find_variables(var_set)
        return var_set
    ...
    def variables(self) -> Set[str]:
        ...
        # Task 1.2
        var_set = set()
        return self.__find_variables(var_set)
    ...
    def parse_prefix(s: str) -> Tuple[Union[Formula, None], str]:
        ...
        while (index < len(s)):
            ...
            if to_parse[index] == "(":
                ...
                if count_par == 1:
                    index_operator = index
            elif (index + 1 < len(s) and s[index] == "-" and s[index + 1] != ">"):
